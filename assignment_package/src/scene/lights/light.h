...
class Light
{
  public:
    ...
    virtual void Pdf_Le(const Ray &ray, const Normal3f &nLight, Float *pdfPos, Float *pdfDir) const {}

    virtual float Pdf_Li(const Intersection &ref, const Vector3f &wi) const {return 0.f;}
